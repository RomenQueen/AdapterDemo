...
//    }
    ...
    public static RecyclerView.ItemDecoration createDecorationDip(Context context,int l, int t, int r, int b) {
        Decoration decoration = new Decoration(0);

        decoration.left(dip2px(context,l)).top(dip2px(context,t)).right(dip2px(context,r)).bottom(dip2px(context,b));
        return decoration.build();
    }
